...
public class ProductService {
    ...
    public Page<? extends ProductDtoInterface> getProductCatalog(Pageable pageable, boolean verbose) {
        ...
        return new PageImpl<ProductCatalogResponseDto>(productCatalogResponseMapper.toResponseList(sortedProducts),
                pageable,
                idsPage.getTotalElements());
    }
    ...
    public Page<? extends ProductDtoInterface> getProductCatalogByCategoryId(Pageable pageable, Long categoryId,
        ...
        return new PageImpl<ProductCatalogResponseDto>(productCatalogResponseMapper.toResponseList(sortedProducts), pageable,
                idsPage.getTotalElements());
    }
