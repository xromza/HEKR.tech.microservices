...
public class ProductRepository__BeanDefinitions {
  ...
  public static BeanDefinition getProductRepositoryBeanDefinition() {
    ...
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "ru.xromza.catalog.repository.ProductRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new ru.xromza.catalog.repository.ProductRepositoryImpl__AotRepository(entityManager, context));
      }
    });
