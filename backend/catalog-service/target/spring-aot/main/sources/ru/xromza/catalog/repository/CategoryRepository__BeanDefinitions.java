...
public class CategoryRepository__BeanDefinitions {
  ...
  public static BeanDefinition getCategoryRepositoryBeanDefinition() {
    ...
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "ru.xromza.catalog.repository.CategoryRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new ru.xromza.catalog.repository.CategoryRepositoryImpl__AotRepository(entityManager, context));
      }
    });
